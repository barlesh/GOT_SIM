...
loop()->
	receive
	{born, {Type, Name, Location} } -> multemedia_server!{update, {Type, Name,  Location, 0} },
					statistics_server!{Type, created};
	{death, {Type, Name}} -> multemedia_server!{remove, {Name} },
			statistics_server!{Type, killed};
	{transition, {Original_Type, Trans_Type, Name, Location} } -> multemedia_server!
