...
changeIMG(Canvas) ->
	X= random:uniform(10),
	case X of 
		1-> IMG=wxImage:new("../Files/GOT1.png");
		2-> IMG=wxImage:new("../Files/GOT2.png");
		3-> IMG=wxImage:new("../Files/GOT3.png");
		4-> IMG=wxImage:new("../Files/GOT4.png");
		5-> IMG=wxImage:new("../Files/GOT5.png");
		6-> IMG=wxImage:new("../Files/GOT6.png");
		7-> IMG=wxImage:new("../Files/GOT7.png");
		8-> IMG=wxImage:new("../Files/GOT8.png");
		9-> IMG=wxImage:new("../Files/GOT9.png");
		10->IMG=wxImage:new("../Files/GOT10.png") 
	end,
	ClientDC = wxClientDC:new(Canvas),
	Bitmap = wxBitmap:new(IMG),
	wxDC:drawBitmap(ClientDC, Bitmap, {0,0}),
